...
<head>
    ...
    <title>Consumer Complaints Post Settings Information</title>       
    ...
    <section id="main-content">
        ...
        <div class="col-lg-12">
                <section class="panel">
                    ...
                    <!--</header>-->                     
                     ...
                     if(isset($_POST['submit'])){
                         ...
                         if(empty($meta_title) || $post_name == "" || empty($meta_author) || empty($meta_description) || empty($meta_keywords)){
                    ?>
                ...
                <?php
                         ...
                         $sel1 = mysql_query("SELECT * FROM cc_settings WHERE settings_page_name = '$post_name'");
                    ...
                    ////Condition to Check whether there is a duplicate record 
                              if($row > 0){
                                ...
                                $updt = mysql_query("UPDATE cc_settings SET settings_page_name = '$post_name',settings_meta_title = '$meta_title', settings_meta_author = '$meta_author', settings_meta_description = '$meta_description', settings_meta_keywords = '$meta_keywords', settings_date = '$date' WHERE settings_id = '$page_id'");
                     ...
                     <?php                      
                        ...
                        $inst = mysql_query("INSERT INTO cc_settings(settings_page_name, settings_meta_title, settings_meta_author, settings_meta_description, settings_meta_keywords, settings_status, settings_date) VALUES('$post_name','$meta_title', '$meta_author', '$meta_description', '$meta_keywords', '$meta_status', '$date')");
        	...
        	?>
                    ...
                    <form name="postsettings_form" class="form-horizontal" action="PostSettings.php" method="post">
                    <div class="panel-body">
                        
                            <div class="form-group">
                                <label class="col-lg-5 col-sm-2 control-label">Post Title</label>
                                <div class="col-lg-6">
                                    <select class="form-control" name="post_name" style="width: 300px" id="source">
                                      <option value="">-- Select Post --</option>                             
                                
                                <?php
                                
                                
                                    $sel_post = mysql_query("SELECT * FROM complaints_info ORDER BY complaint_id DESC");
                            
                             while($prow = mysql_fetch_array($sel_post))
                             {
                                $post_name = $prow['complaint_cname'];
                                $post_id = $prow['complaint_id'];
                                ...
                                <div style="margin-left: 465px;">( Select the post name to which you want to apply the settings )</div>
