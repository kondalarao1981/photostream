        ...
        <div class="col-lg-12">
                <section class="panel">
                    ...
                    <?php
                         ...
                         $cat_name = ucwords($_POST['category_name']);
                        ...
                        <strong>Please Enter Category Name</strong>
                    </div>
                    <?php
                         }
                         else{
		  ...
		  ?>
            ...
            ?>
                ...
                <button type="button" class="close" data-dismiss="alert">&times;</button>
                <strong>New category has been added.</strong>
            </div>   
    <?php
          ...
          ?>
                    ...
                    <div class="panel-body">
                        <div class="position-center">
                            <form name="category_form" class="form-horizontal" name="cat" action="AddCategory.php" method="post">
                            <div class="form-group">
                                <label for="inputEmail1" class="col-lg-4 col-sm-2 control-label">Category Name</label>
                                <div class="col-lg-6">
